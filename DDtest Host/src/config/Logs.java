...
public class Logs 
{
	...
	public static String logFilePath = "C:\\HammerHost\\log_server.txt";
	public static int logLevel = Config.logLevel; //6 = trace, 0 = none
	...
	private static void writeToFile(String str)
	{
		try
		{
			PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter(logFilePath, true)), true);
			out.println(str);
			out.close();
		}
		catch (Exception e)
	...
	public static void writeToFile(String str, String filePath)
	{
		try
		{
			PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("C:\\HammerHost\\" + filePath, true)), true);
			out.println(str);
			out.close();
		}
		catch (Exception e)
